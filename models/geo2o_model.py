...
class Model(nn.Module):
    """Geo2O-HMR one-stage multi-person mesh estimator."""
    def __init__(self, encoder, decoder,
        ...
        # ========== Start of scale-adaptive-token encoder settings =============
        ...
        # ========== End of scale-adaptive-token encoder settings =============
...
def build_geo2o_model(args, set_criterion=True):
    ...
    if set_criterion:
        ...
        criterion = SetCriterion(
            ...
            conf_loss_type=getattr(args, 'conf_loss_type', 'focal'),
            mal_gamma=getattr(args, 'mal_gamma', 1.5),
        )
