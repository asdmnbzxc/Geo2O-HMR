...
import time
import datetime
from models import build_geo2o_model
...
class Engine():
    ...
    def prepare_models(self, args):
        ...
        self.unwrapped_model, self.criterion = build_geo2o_model(args, set_criterion = (self.mode == 'train'))
    ...
    def prepare_datas(self, args):
        ...
        if self.mode == 'train':
            ...
            train_dataset = MultipleDatasets(args.train_datasets_used, args.train_datasets_split,
                                        ...
                                        geo2o_cfg=getattr(args, 'geo2o_cfg', None))
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if hasattr(self, 'train_dataset') and hasattr(self.train_dataset, 'set_epoch'):
                self.train_dataset.set_epoch(epoch, self.num_epochs)
