...
def get_args_parser():
    parser = argparse.ArgumentParser('Geo2O-HMR', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Geo2O-HMR training and evaluation script', parents=[get_args_parser()])
